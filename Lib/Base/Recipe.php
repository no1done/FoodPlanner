...
abstract class Recipe implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Lib\\Map\\RecipeTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildRecipeItem> Collection to store aggregation of ChildRecipeItem objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildDayPlanRecipe> Collection to store aggregation of ChildDayPlanRecipe objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildRecipeItem>
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildDayPlanRecipe>
     */
    ...
    /**
     * Initializes internal state of Lib\Base\Recipe object.
     * @see applyDefaults()
     */
    ...
    public function setCalories($v)
    {
        ...
        if ($this->calories !== $v) {
            $this->calories = $v;
            $this->modifiedColumns[RecipeTableMap::COL_CALORIES] = true;
        }
    ...
    public function setRemoved($v)
    {
        ...
        if ($this->removed !== $v) {
            $this->removed = $v;
            $this->modifiedColumns[RecipeTableMap::COL_REMOVED] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[RecipeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[RecipeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RecipeTableMap::translateFieldName('Calories', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calories = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RecipeTableMap::translateFieldName('Instructions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->instructions = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RecipeTableMap::translateFieldName('Removed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->removed = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : RecipeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : RecipeTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = RecipeTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(RecipeTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(RecipeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(RecipeTableMap::COL_UPDATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(RecipeTableMap::COL_CALORIES)) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getCalories(),
            $keys[3] => $this->getInstructions(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setCalories($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setInstructions($arr[$keys[3]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(RecipeTableMap::COL_CALORIES)) {
            $criteria->add(RecipeTableMap::COL_CALORIES, $this->calories);
        }
        if ($this->isColumnModified(RecipeTableMap::COL_INSTRUCTIONS)) {
        ...
        if ($this->isColumnModified(RecipeTableMap::COL_CREATED_AT)) {
            $criteria->add(RecipeTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(RecipeTableMap::COL_UPDATED_AT)) {
            $criteria->add(RecipeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Lib\Recipe (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Lib\Recipe Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function setListRecipes(Collection $listRecipes, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($listRecipesToDelete as $listRecipeRemoved) {
            $listRecipeRemoved->setRecipe(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildListRecipe}> List of ChildListRecipe objects
     */
    public function getListRecipesJoinShoppingList(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildListRecipeQuery::create(null, $criteria);
     ...
     * @return void
     */
    public function resetPartialRecipeItems($v = true): void
    {
     ...
     * @return void
     */
    public function initRecipeItems(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildRecipeItem> List of ChildRecipeItem objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collRecipeItems || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collRecipeItems) {
                    ...
                    $collRecipeItems = new $collectionClassName;
                    $collRecipeItems->setModel('\Lib\RecipeItem');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countRecipeItems(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collRecipeItemsPartial && !$this->isNew();
        if (null === $this->collRecipeItems || null !== $criteria || $partial) {
     ...
     */
    protected function doAddRecipeItem(ChildRecipeItem $recipeItem): void
    {
     ...
     * @return void
     */
    public function resetPartialDayPlanRecipes($v = true): void
    {
     ...
     * @return void
     */
    public function initDayPlanRecipes(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildDayPlanRecipe> List of ChildDayPlanRecipe objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collDayPlanRecipes || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collDayPlanRecipes) {
                    ...
                    $collDayPlanRecipes = new $collectionClassName;
                    $collDayPlanRecipes->setModel('\Lib\DayPlanRecipe');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countDayPlanRecipes(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collDayPlanRecipesPartial && !$this->isNew();
        if (null === $this->collDayPlanRecipes || null !== $criteria || $partial) {
     ...
     */
    protected function doAddDayPlanRecipe(ChildDayPlanRecipe $dayPlanRecipe): void
    {
