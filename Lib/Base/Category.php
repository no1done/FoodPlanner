...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Lib\\Map\\CategoryTableMap';
     ...
     * @return $this|\Lib\Category The current object (for fluent API support)
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Lib\Category The current object, for fluid interface
     */
