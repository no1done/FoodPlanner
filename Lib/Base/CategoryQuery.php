 ...
 * @method     ChildCategory findOneByKey(string $key) Return the first ChildCategory filtered by the key column
 ...
 * @method     ChildCategory[]|ObjectCollection findByKey(string $key) Return ChildCategory objects filtered by the key column
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    public function filterByKey($key = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_KEY, $key, $comparison);
    }
