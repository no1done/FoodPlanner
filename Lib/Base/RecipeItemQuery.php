 ...
 *
 * @method     ChildRecipeItem findOne(ConnectionInterface $con = null) Return the first ChildRecipeItem matching the query
 ...
 *
 * @method     ChildRecipeItem findOneById(int $id) Return the first ChildRecipeItem filtered by the id column
 * @method     ChildRecipeItem findOneByRecipeId(int $recipe_id) Return the first ChildRecipeItem filtered by the recipe_id column
 * @method     ChildRecipeItem findOneByItemId(int $item_id) Return the first ChildRecipeItem filtered by the item_id column
 * @method     ChildRecipeItem findOneByQuantity(double $quantity) Return the first ChildRecipeItem filtered by the quantity column
 * @method     ChildRecipeItem findOneByCreatedAt(string $created_at) Return the first ChildRecipeItem filtered by the created_at column
 * @method     ChildRecipeItem findOneByUpdatedAt(string $updated_at) Return the first ChildRecipeItem filtered by the updated_at column *
 ...
 *
 * @method     ChildRecipeItem[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildRecipeItem objects based on current ModelCriteria
 * @method     ChildRecipeItem[]|ObjectCollection findById(int $id) Return ChildRecipeItem objects filtered by the id column
 * @method     ChildRecipeItem[]|ObjectCollection findByRecipeId(int $recipe_id) Return ChildRecipeItem objects filtered by the recipe_id column
 * @method     ChildRecipeItem[]|ObjectCollection findByItemId(int $item_id) Return ChildRecipeItem objects filtered by the item_id column
 * @method     ChildRecipeItem[]|ObjectCollection findByQuantity(double $quantity) Return ChildRecipeItem objects filtered by the quantity column
 * @method     ChildRecipeItem[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildRecipeItem objects filtered by the created_at column
 * @method     ChildRecipeItem[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildRecipeItem objects filtered by the updated_at column
...
abstract class RecipeItemQuery extends ModelCriteria
{
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildRecipeItemQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(RecipeItemTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByRecipeId($recipeId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_RECIPE_ID, $recipeId, $comparison);
    }
    ...
    public function filterByItemId($itemId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_ITEM_ID, $itemId, $comparison);
    }
    ...
    public function filterByQuantity($quantity = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_QUANTITY, $quantity, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RecipeItemTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildRecipeItemQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(RecipeItemTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(RecipeItemTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(RecipeItemTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(RecipeItemTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(RecipeItemTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(RecipeItemTableMap::COL_CREATED_AT);
    }
