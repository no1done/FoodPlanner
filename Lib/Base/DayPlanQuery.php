 ...
 *
 * @method     ChildDayPlan findOne(ConnectionInterface $con = null) Return the first ChildDayPlan matching the query
...
abstract class DayPlanQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(DayPlanTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(DayPlanTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DayPlanTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DayPlanTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DayPlanTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildDayPlanQuery The current query, for fluid interface
     */
    ...
    {
        return $this->addUsingAlias(DayPlanTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(DayPlanTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(DayPlanTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(DayPlanTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(DayPlanTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(DayPlanTableMap::COL_CREATED_AT);
    }
