...
/**
 * Base class that represents a row from the 'list_recipe' table.
 *
 *
 *
 * @package    propel.generator.Lib.Base
 */
abstract class ListRecipe implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Lib\\Map\\ListRecipeTableMap';
    ...
    /**
     * Compares this with another <code>ListRecipe</code> instance.  If
     * <code>obj</code> is an instance of <code>ListRecipe</code>, delegates to
     * <code>equals(ListRecipe)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ListRecipe The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ListRecipeTableMap::COL_ID] = true;
        }
    ...
    public function setShoppingListId($v)
    {
        ...
        if ($this->shopping_list_id !== $v) {
            ...
            $this->modifiedColumns[ListRecipeTableMap::COL_SHOPPING_LIST_ID] = true;
        }
    ...
    public function setRecipeId($v)
    {
        ...
        if ($this->recipe_id !== $v) {
            $this->recipe_id = $v;
            $this->modifiedColumns[ListRecipeTableMap::COL_RECIPE_ID] = true;
        }
    ...
    public function setServes($v)
    {
        ...
        if ($this->serves !== $v) {
            $this->serves = $v;
            $this->modifiedColumns[ListRecipeTableMap::COL_SERVES] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ListRecipeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ListRecipeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ListRecipeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ListRecipeTableMap::translateFieldName('ShoppingListId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildListRecipeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ListRecipe::setDeleted()
     * @see ListRecipe::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildListRecipeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ListRecipeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ListRecipeTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ListRecipeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ListRecipeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ListRecipeTableMap::COL_SHOPPING_LIST_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO list_recipe (%s) VALUES (%s)',
    ...
    {
        $pos = ListRecipeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ListRecipe'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ListRecipe'][$this->hashCode()] = true;
        $keys = ListRecipeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Lib\ListRecipe The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ListRecipeTableMap::COL_ID)) {
            $criteria->add(ListRecipeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ListRecipeTableMap::COL_SHOPPING_LIST_ID)) {
            $criteria->add(ListRecipeTableMap::COL_SHOPPING_LIST_ID, $this->shopping_list_id);
        }
        if ($this->isColumnModified(ListRecipeTableMap::COL_RECIPE_ID)) {
        ...
        if ($this->isColumnModified(ListRecipeTableMap::COL_UPDATED_AT)) {
            $criteria->add(ListRecipeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildListRecipeQuery::create();
        $criteria->add(ListRecipeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Lib\ListRecipe (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Lib\ListRecipe Clone of current object.
     * @throws PropelException
     */
    ...
    public function getShoppingList(ConnectionInterface $con = null)
    {
        if ($this->aShoppingList === null && ($this->shopping_list_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aShoppingList->addListRecipes($this);
             */
        }
    ...
    public function getRecipe(ConnectionInterface $con = null)
    {
        if ($this->aRecipe === null && ($this->recipe_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRecipe->addListRecipes($this);
             */
        }
    ...
    {
        if (null !== $this->aShoppingList) {
            $this->aShoppingList->removeListRecipe($this);
        }
        if (null !== $this->aRecipe) {
            $this->aRecipe->removeListRecipe($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ListRecipeTableMap::DEFAULT_STRING_FORMAT);
    }
