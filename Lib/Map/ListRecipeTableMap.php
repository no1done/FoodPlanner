...
class ListRecipeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Lib.Map.ListRecipeTableMap';
     ...
     */
    const TABLE_NAME = 'list_recipe';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Lib\\ListRecipe';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Lib.ListRecipe';
     ...
     */
    const COL_ID = 'list_recipe.id';

    /**
     * the column name for the shopping_list_id field
     */
    const COL_SHOPPING_LIST_ID = 'list_recipe.shopping_list_id';

    /**
     * the column name for the recipe_id field
     */
    const COL_RECIPE_ID = 'list_recipe.recipe_id';
     ...
     */
    const COL_UPDATED_AT = 'list_recipe.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ShoppingListId', 'RecipeId', 'Serves', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'shoppingListId', 'recipeId', 'serves', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ListRecipeTableMap::COL_ID, ListRecipeTableMap::COL_SHOPPING_LIST_ID, ListRecipeTableMap::COL_RECIPE_ID, ListRecipeTableMap::COL_SERVES, ListRecipeTableMap::COL_CREATED_AT, ListRecipeTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'shopping_list_id', 'recipe_id', 'serves', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ShoppingListId' => 1, 'RecipeId' => 2, 'Serves' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'shoppingListId' => 1, 'recipeId' => 2, 'serves' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(ListRecipeTableMap::COL_ID => 0, ListRecipeTableMap::COL_SHOPPING_LIST_ID => 1, ListRecipeTableMap::COL_RECIPE_ID => 2, ListRecipeTableMap::COL_SERVES => 3, ListRecipeTableMap::COL_CREATED_AT => 4, ListRecipeTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'shopping_list_id' => 1, 'recipe_id' => 2, 'serves' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ListRecipeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ListRecipeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ListRecipeTableMap());
        }
    }
...
//
ListRecipeTableMap::buildTableMap();
