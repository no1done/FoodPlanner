...
class CategoryTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Lib.Map.CategoryTableMap';
     ...
     */
    public const OM_CLASS = '\\Lib\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Lib.Category';
     ...
     */
    public const COL_KEY = 'category.key';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'category.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'category.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'Key', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'key', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [CategoryTableMap::COL_ID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_KEY, CategoryTableMap::COL_CREATED_AT, CategoryTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'key', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'Key' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'key' => 2, 'createdAt' => 3, 'updatedAt' => 4, ],
        self::TYPE_COLNAME       => [CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_NAME => 1, CategoryTableMap::COL_KEY => 2, CategoryTableMap::COL_CREATED_AT => 3, CategoryTableMap::COL_UPDATED_AT => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'key' => 2, 'created_at' => 3, 'updated_at' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'key' => 'KEY',
        'category.key' => 'KEY',
        'CategoryTableMap::COL_KEY' => 'KEY',
        'COL_KEY' => 'KEY',
        'CreatedAt' => 'CREATED_AT',
        'Category.CreatedAt' => 'CREATED_AT',
        'createdAt' => 'CREATED_AT',
        'category.createdAt' => 'CREATED_AT',
        'CategoryTableMap::COL_CREATED_AT' => 'CREATED_AT',
        ...
        'updatedAt' => 'UPDATED_AT',
        'category.updatedAt' => 'UPDATED_AT',
        'CategoryTableMap::COL_UPDATED_AT' => 'UPDATED_AT',
  ...
  array (
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(CategoryTableMap::COL_KEY);
            $criteria->removeSelectColumn(CategoryTableMap::COL_CREATED_AT);
            $criteria->removeSelectColumn(CategoryTableMap::COL_UPDATED_AT);
        } else {
